            ...
            child: SingleChildScrollView(
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: white.withOpacity(0.15), width: 1.5),
                ),
                child: const Icon(Icons.email_outlined, color: white, size: 38),
              ),
              ...
              Text(
                ...
                style: GoogleFonts.poppins(
                    color: hintGrey, fontSize: 13, height: 1.6),
              ),
