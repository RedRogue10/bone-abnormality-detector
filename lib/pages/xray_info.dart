...
class _XrayInfoState extends State<XrayInfo> with RouteAware {
  ...
  Widget build(BuildContext context) {
    ...
    final topBonePart = _result!.topPredictions.isNotEmpty
        ? _result!.topPredictions.first.bonePart
        : null;
    final threshold = thresholdFor(topBonePart);
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          const SizedBox(height: 20),
                          Text(
                            '${displayConfidence.toStringAsFixed(1)}% Likelihood of Abnormality',
                            style: GoogleFonts.oswald(
                              fontSize: 24,
                              color: white,
                            ),
